...
INSERT INTO `dbo`.  `ProgrammingLanguage` (`idTechnique`,   `programmingLanguage` ) VALUES (  @var_id ,'Java, C, C++');
...
INSERT INTO `dbo`.  `SynchronizationMechanism`  (`idTechnique`,   `synchronizationMechanism`  ) VALUES (  @var_id ,'Happens-before relation');
...
INSERT INTO `dbo`.  `ConcurrentBugs`  (`idTechnique`,   `concurrentBugs`  ) VALUES (  @var_id ,'Deadlock');
...
INSERT INTO `dbo`.  `ConcurrentBugs`  (`idTechnique`,   `concurrentBugs`  ) VALUES (  @var_id ,'Deadlock, Data race, atomicity violation');

INSERT INTO `dbo`.  `ToolName`  (`idTechnique`,   `toolName`  ) VALUES (  @var_id ,'Convoider');
...
INSERT INTO `dbo`.  `ProgrammingLanguage` (`idTechnique`,   `programmingLanguage` ) VALUES (  @var_id ,'MPI');

INSERT INTO `dbo`.  `TestingTechnique`  (`idTechnique`,   `testingTechnique`  ) VALUES ( @var_id ,'Structural testing');

INSERT INTO `dbo`.  `TestDataGeneration`  (`idTechnique`,   `testDataGeneration`  ) VALUES (  @var_id ,'Thread interaction models');

INSERT INTO `dbo`.  `TestingLevel`  (`idTechnique`,   `testingLevel`  ) VALUES (  @var_id, 'Unit');

INSERT INTO `dbo`.  `SynchronizationMechanism`  (`idTechnique`,   `synchronizationMechanism`  ) VALUES (  @var_id ,'Happens-before relation');

INSERT INTO `dbo`.  `Input` (`idTechnique`,   `input` ) VALUES (  @var_id ,'Concurrent code in MPI');
...
INSERT INTO `dbo`.  `ConcurrentBugs`  (`idTechnique`,   `concurrentBugs`  ) VALUES (  @var_id ,'Data race');

INSERT INTO `dbo`.  `ToolName`  (`idTechnique`,   `toolName`  ) VALUES (  @var_id ,'ThreadSanitizer');
...
INSERT INTO `dbo`.  `TestingTechnique`  (`idTechnique`,   `testingTechnique`  ) VALUES ( @var_id ,'Fault-based testing');

INSERT INTO `dbo`.  `TestDataGeneration`  (`idTechnique`,   `testDataGeneration`  ) VALUES (  @var_id ,'Coverage criteria');

INSERT INTO `dbo`.  `TestingLevel`  (`idTechnique`,   `testingLevel`  ) VALUES (  @var_id, 'Unit');

INSERT INTO `dbo`.  `SynchronizationMechanism`  (`idTechnique`,   `synchronizationMechanism`  ) VALUES (  @var_id ,'Reachability testing');

INSERT INTO `dbo`.  `Input` (`idTechnique`,   `input` ) VALUES (  @var_id ,'Multithread code');

INSERT INTO `dbo`.  `Output`  (`idTechnique`,   `output`  ) VALUES (  @var_id ,'Partially-ordered sequences');

INSERT INTO `dbo`.  `QualityAttribute`  (`idTechnique`,   `qualityAttribute`  ) VALUES (  @var_id ,'Effectiveness, Performance');
...
INSERT INTO `dbo`.  `ConcurrentBugs`  (`idTechnique`,   `concurrentBugs`  ) VALUES (  @var_id ,'Mutation based errors');

INSERT INTO `dbo`.  `ToolName`  (`idTechnique`,   `toolName`  ) VALUES (  @var_id ,'SplitRichTest');
...
INSERT INTO `dbo`.  `ConcurrentBugs`  (`idTechnique`,   `concurrentBugs`  ) VALUES (  @var_id ,'Bugs inserted by the researcher');

INSERT INTO `dbo`.  `ToolName`  (`idTechnique`,   `toolName`  ) VALUES (  @var_id ,'TestMinimizer');
...
INSERT INTO `dbo`.  `ProgrammingLanguage` (`idTechnique`,   `programmingLanguage` ) VALUES (  @var_id ,'.Net, C#');
...
INSERT INTO `dbo`.  `ConcurrentBugs`  (`idTechnique`,   `concurrentBugs`  ) VALUES (  @var_id ,'Thread-safety violations, Data race');

INSERT INTO `dbo`.  `ToolName`  (`idTechnique`,   `toolName`  ) VALUES (  @var_id ,'TSVD');
...
INSERT INTO `dbo`.`executionPlatform` (`idTechnique`, `executionPlatform`) VALUES ( @var_id ,'No Information');

INSERT INTO `dbo`.  `Objective` (`idTechnique`,   `objective` ) VALUES (  @var_id ,'HPC');

INSERT INTO `dbo`.  `ProgrammingLanguage` (`idTechnique`,   `programmingLanguage` ) VALUES (  @var_id ,'No Information');
...
INSERT INTO `dbo`.  `StateSpaceReduction` (`idTechnique`,   `stateSpaceReduction` ) VALUES (  @var_id ,'Incremental reachability analysis');

INSERT INTO `dbo`.  `ConcurrentBugs`  (`idTechnique`,   `concurrentBugs`  ) VALUES (  @var_id ,'Deadlock');

INSERT INTO `dbo`.  `ToolName`  (`idTechnique`,   `toolName`  ) VALUES (  @var_id ,'DeadlOx');
