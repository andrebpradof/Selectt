								...
								<? if (isset($info)): ?>
									<?php foreach($info as $temp) : ?>
										<tr>
											...
											<td><?php echo $temp['expiration']; ?></td>
											...
											<td>
												...
												<!-- Edit button -->
												<a href="<?php echo base_url('admin/editUserResult/'. $temp['id']); ?>">
												...
												<!-- Delete button -->
												<a href="<?php echo base_url('admin/deleteUserResult/'. $temp['id']); ?>">
...
<script type="text/javascript">
	...
	function openModal(el) {
		...
		httpRequest.open('GET', window.location.origin + '/~selectt/api/userResult/id/' + id, false);
